...
export default {
  ...
  theme: {
    extend: {
      colors: {
        ink: '#0d1f14', muted: '#6f7d75', accent: '#16a34a', surface: '#f7faf8', paper: '#ffffff', line: '#dfe8e2',
        brand: { 50: '#edf7f2', 100: '#c8eadb', 200: '#93d4b8', 300: '#5ab896', 400: '#2d9c77', 500: '#1a7f5e', 600: '#156649', 700: '#0f4d37', 800: '#093325', 900: '#041a13' },
        cream: { 50: '#fdfcf8', 100: '#f9f7f0', 200: '#f2ede3', 300: '#e6ded0', 400: '#d4cab8' },
      ...
      animation: {
        'fade-in-up': 'fade-in-up 0.4s cubic-bezier(0.16, 1, 0.3, 1) both', 'fade-in': 'fade-in 0.3s ease both', shimmer: 'shimmer 1.5s ease-in-out infinite', 'count-up': 'count-up 0.5s cubic-bezier(0.16, 1, 0.3, 1) both', 'pulse-dot': 'pulse-dot 2s ease-in-out infinite',
      },
    },
  },
  plugins: [],
