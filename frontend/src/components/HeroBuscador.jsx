...
export default function HeroBuscador({ ean, setEan, loading, error, onBuscar, onAbrirScanner }) {
  return <section id="inicio" className="overflow-hidden bg-surface px-4 py-10 sm:py-12 md:py-14 lg:py-20">
    <div className="mx-auto max-w-[1120px]">
      ...
      <div className="reveal [transition-delay:320ms]"><p className="flex flex-wrap gap-x-6 gap-y-1 text-[0.8125rem] font-medium tracking-[0.01em] text-ink/45"><span>Gratis · Sin registro · Sin complicaciones</span></p></div>
    </div>
  </section>;
}
