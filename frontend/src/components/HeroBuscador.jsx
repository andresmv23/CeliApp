    ...
    <div className="mx-auto max-w-[1120px]">
      ...
      <form className="reveal mb-4 max-w-[680px] [transition-delay:200ms]" onSubmit={onBuscar}>
        <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-1.5 rounded-2xl border-[1.5px] border-ink/10 bg-white p-2 shadow-[0_2px_12px_rgba(13,31,20,0.05)] sm:grid-cols-[auto_minmax(260px,1fr)_auto_auto] sm:rounded-full sm:p-1.5">
          <span className="flex shrink-0 items-center pl-3 text-ink/25"><svg className="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 0 14 0z" /></svg></span>
